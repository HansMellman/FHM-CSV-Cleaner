...
st.set_page_config(page_title="Team Records Cleaner", page_icon="📃")
...
if team_records is not None:
    if team_records.name != "team_records.csv":
        st.write("Please upload the correct team_records.csv")
    elif team_records.name == "team_records.csv":
